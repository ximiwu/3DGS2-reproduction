...
struct float2x2 {
    ...
    __host__ __device__ float2& operator[](int i) {
        return m_rows[i];
    }

    __host__ __device__ const float2& operator[](int i) const {
        return m_rows[i];
    }
};
